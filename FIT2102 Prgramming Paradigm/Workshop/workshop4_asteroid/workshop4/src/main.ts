 ...
 */
import { fromEvent, interval, Subscription, Observable , merge ,scan , from} from 'rxjs';
import { map, filter, concatMap} from 'rxjs/operators';
import { Key, Event, Action, State } from './types'
import { Tick, Rotate, Thrust, Shoot, initialState, reduceState , Teleport} from './state';
...
//  - "Restart" button rather than reload to play again
////////////////////////////////////////////////////////////////////
...
function asteroids() {
   ...
   */
  const action$: Observable<Action> = merge(tick$, startLeftRotate$, startRightRotate$, stopLeftRotate$, stopRightRotate$, startThrust$, stopThrust$, shoot$,teleport$);
